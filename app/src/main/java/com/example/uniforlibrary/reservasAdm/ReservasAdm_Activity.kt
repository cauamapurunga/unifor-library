...
fun ReservasAdmScreen() {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Gerenciar Reservas", color = Color.White, fontWeight = FontWeight.Bold) },
        ...
        Column(
            ...
            Text("Tela de Gerenciamento de Reservas")
        }
    }
}
...
fun AdminBottomNav(context: Context, selectedItemIndex: Int) {
    val navigationItems = listOf(
        ...
        AdminBottomNavItem("Reservas", Icons.Default.Bookmark, 3) { /* Já está aqui */ },
        AdminBottomNavItem("Relatórios", Icons.Default.Assessment, 4) { /* TODO */ }
    )
